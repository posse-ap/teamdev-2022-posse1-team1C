                         ...
                         <form method="POST" action="{{ route('register') }}">
                             ...
                             <div>
                                <div class="flex">
                                 ...
                                 <div class="flex">
                                     <input id="password" type="password" class="bg-gray-100 mb-6 mt-2 w-full h-10 p-2  rounded @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                             ...
                             <div>
                                <div class="flex">
                                 ...
                                 <div class="flex">
                                     <input id="password-confirm" type="password" class="bg-gray-100 mb-6 mt-2 w-full h-10 p-2 rounded" name="password_confirmation" required autocomplete="new-password" placeholder="上と同じパスワードを入力してください">
                             ...
                             <div>
                                <div class="flex">
                                 ...
                                 <div class="flex">
                                     <input id="company-name" type="text" class="bg-gray-100 mb-6 mt-2 w-full h-10 p-2 rounded" name=""  placeholder="会社名">
                                 </div>
                             </div>
                             <div>
                                <div class="flex">
                                 ...
                                 <div class="flex">
                                     <input id="department-name" type="text" class="bg-gray-100 mb-6 mt-2 w-full h-10 p-2 rounded" name="password_confirmation"  placeholder="部署名">
                                 </div>
                             </div>
                             <div>
                                 <div class="flex">
                                    <label for="password-confirm" class="col-form-label text-md-right font-bold">{{ __('電話番号') }}</label>
                                    <div class="border bg-red-500 text-white text-xs px-4 pt-1 rounded ml-2">必須</div>
                                </div>
                                 <div class="flex">
                                     <input type="number" class="bg-gray-100 mb-6 mt-2 w-full h-10 p-2 rounded" name="password_confirmation">
                                 </div>
                             </div>
                             <div>
                                 <div class="flex">
                                    <label for="password-confirm" class="col-form-label text-md-right font-bold">{{ __('paypay送金リンク') }}</label>
                                    <div class="border bg-red-500 text-white text-xs px-4 pt-1 rounded ml-2">必須</div>
                                </div>
                                 <div class="flex">
                                     <input type="url" class="bg-gray-100 mb-6 mt-2 w-full h-10 p-2 rounded" name="" placeholder="https://example.com" >
                                 </div>
                             </div>

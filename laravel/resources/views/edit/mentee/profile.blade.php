        ...
        <div class="flex justify-center items-center py-20">
            ...
            <div class="bg-white inline-block px-20 py-20 -mt-10">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div>
                        <label for="password-confirm" class="font-bold flex">{{ __('確認用パスワード') }}</label>
                        <div class="flex mb-6 mt-2 relative">
                            <input id="password-confirm" type="password" class="bg-gray-100 w-full h-10 p-2 rounded"
                                name="password_confirmation" required autocomplete="new-password"
                                placeholder="上と同じパスワードを入力してください">
                            <span id="buttonEye2" class="fa fa-eye absolute right-5 top-1/2 -translate-y-1/2"></span>
                        </div>
                    </div>

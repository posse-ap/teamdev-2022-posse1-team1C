            ...
            <div class="flex justify-center items-center py-20 ml-20">
                    <div class="bg-white inline-block px-20 py-20 ml-20">
                        ...
                        <p class="flex justify-center items-center font-bold mb-16">相談はできましたか？</p>
                            <input type="button" value="できた" class="bg-teal-400 text-white rounded px-12 py-10" onclick="location.href='{{route('mentee.survey.reason')}}'">
                            <input type="button" value="できなかった" class="bg-red-400 text-white rounded px-7 py-10 ml-10" onclick="location.href='{{route('mentee.survey.cancel')}}'">
                    </div> 
               </div>
           </div>
       </div>

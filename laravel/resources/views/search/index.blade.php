                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 flex justify-center items-center">
                                    <input id="" type="text"
                                        class="bg-white outline outline-gray-400 mb-6 mt-2 w-full h-10 p-2 form-control" name="email"
                                        value="" required autocomplete="email" autofocus placeholder="社名を入力してください">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 flex justify-center items-center">
                                    <input id="" type="text"
                                        class="bg-white outline outline-gray-400 mb-6 mt-2 w-full h-10 p-2 form-control" name="email"
                                        value="" required autocomplete="email" autofocus placeholder="部署名を入力してください">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 flex justify-center items-center">
                                    <button class=" bg-gradient-to-r from-sky-500 to-indigo-500 outline-gray-500 text-white text-2xl font-bold w-full h-10 p-2 mt-2  rounded form-control">

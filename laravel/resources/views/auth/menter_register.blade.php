                 ...
                 <div class="card-body bg-white inline-block px-20 py-20">
                     ...
                     <div class="card-body">
                         <form method="POST" action="{{ route('register') }}">
                             ...
                             <div class="form-group row">
                                <div class="flex">
                                    <label for="password-confirm" class="col-md-4 col-form-label text-md-right font-bold">{{ __('確認用パスワード') }}</label>
                                    <div class="border bg-red-500 text-white text-xs px-4 pt-1 rounded ml-2">必須</div>
                                </div>
                                 <div class="col-md-6 flex">
                             ...
                             <div class="form-group row">
                                <div class="flex">
                                 ...
                                 <div class="col-md-6 flex">
                                     <input id="company-name" type="text" class="bg-gray-100 mb-6 mt-2 w-full h-10 p-2 rounded form-control" name=""  placeholder="会社名">
                                 </div>
                             </div>

                             <div class="form-group row">
                                <div class="flex">
                                    <label for="password-confirm" class="col-md-4 col-form-label text-md-right font-bold">{{ __('部署名') }}</label>
                                    <div class="border bg-red-500 text-white text-xs px-4 pt-1 rounded ml-2">必須</div>
                                </div>
                                 <div class="col-md-6 flex">
                                     <input id="department-name" type="text" class="bg-gray-100 mb-6 mt-2 w-full h-10 p-2 rounded form-control" name="password_confirmation"  placeholder="部署名">
                                 </div>
                             </div>

                             <div class="form-group row">
                                 <div class="flex">
                                    <label for="password-confirm" class="col-md-4 col-form-label text-md-right font-bold">{{ __('電話番号') }}</label>
                                    <div class="border bg-red-500 text-white text-xs px-4 pt-1 rounded ml-2">必須</div>
                                </div>
                                 <div class="col-md-6 flex">
                             ...
                             <div class="form-group row">
                                 <div class="flex">
                                    <label for="password-confirm" class="col-md-4 col-form-label text-md-right font-bold">{{ __('paypay送金リンク') }}</label>
                                    <div class="border bg-red-500 text-white text-xs px-4 pt-1 rounded ml-2">必須</div>
                                </div>
                                 <div class="col-md-6 flex">

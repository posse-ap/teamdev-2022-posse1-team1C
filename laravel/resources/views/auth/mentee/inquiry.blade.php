            ...
            <div>
                <div class="flex justify-center items-center py-20">
                    <div class="bg-white inline-block px-20 py-20">
                            ...
                            <div>
                                ...
                                <div>
                                    <input id="name" type="text"
                                        class="bg-gray-100 mb-6 mt-2 w-full h-10 p-2 rounded @error('name') is-invalid @enderror"
                        ...
                        <div>
                            <button type="submit"
                                class="bg-teal-400 text-white rounded shadow-lg px-20 mt-5 ml-20">送信</button>
                        </div>
                    </div>
                </div>
            </div>

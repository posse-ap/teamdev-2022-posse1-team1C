                            ...
                            <div>
                                ...
                                <div>
                                    <input id="email" type="email"
                                        class="bg-gray-100 mb-6 mt-2 w-11/12 h-10 p-2 rounded @error('email') is-invalid @enderror"
                            ...
                            <div>
                                ...
                                <div class="flex mb-6 mt-2 relative">
                                    <input id="password" type="password"
                                        class="bg-gray-100 w-11/12 h-10 p-2 rounded @error('password') is-invalid @enderror"
                                        name="password" required autocomplete="new-password" placeholder="Password">
                                    <span id="buttonEye"
                                        class="fa fa-eye mt-2"></span>
                                    @error('password')
                                        <span role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div>
                                ...
                                <div class="flex mb-6 mt-2 relative">
                                    <input id="password-confirm" type="password"
                                        class="bg-gray-100 w-11/12 h-10 p-2 rounded" name="password_confirmation"

...
<img src="{{asset('img/top-main-image.png')}}" class="mt-12" alt="">
...
<div class="bg-white">
    ...
    <div class="flex justify-center">
        <div class="mr-10 text-gray-700">
            ...
            <p>「月契約で、困った時に質問できるようにする」「エラーを解決するために単発で相<br>談する」など、あなたの悩みにあわせた契約形態を選ぶことができます。単発契約は<br>1,000円〜、月額契約は3,000円〜と学習を継続しやすい価格になっています。</p>
        </div>
        <img src="{{asset('img/pig-image.png')}}" class="mt-10 ml-10 w-4/12 overflow-x-auto space-x-2 whitespace-nowrap w-full" alt=""> 
    </div>
...
<div class="bg-slate-100 flex justify-center pb-32">
        <div>
            ...
            <button class="ml-14 mt-10 px-16 py-4 bg-teal-400 text-xl text-white font-semibold rounded hover:bg-blue-400">今すぐ始める</button>

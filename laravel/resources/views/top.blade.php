        ...
        <div>
            <div class="flex justify-center">
                <div class="ml-8 mt-14">
                    ...
                    <ul class="text-lg text-gray-700">
                        <li>・時間が無くて焦っている</li>
                        <li>・ネットの情報だけでは不安</li>
                        <li>・転職先の事情を生の声で聞きたい</li>
                        <li>・とにかく自分だけでは判断できない</li>
            ...
            <div class="flex justify-center">
                ...
                <div class="ml-14 mt-12">
                    <h2 class="text-teal-500 text-2xl font-bold mb-10">「行きたい会社に知り合いがいない。<br>人事を通すといいことしか言われないかも...」</h2>
                    <ul class="text-lg text-gray-700">
                        <li>・転職で失敗したことがある</li>
                        <li>・ポジティブな話しか聞かないため不安</li>
                        <li>・転職先に知り合いがいない</li>
                        <li>・転職を必ず成功させたい</li>
                    </ul>
                </div>
    ...
    <div class="bg-white">
        ...
        <div class="flex justify-center">
            <div class="mr-10 text-gray-700">
                <h2 class="text-teal-500 text-2xl font-bold mb-6 mt-20">完全匿名性だから、安心</h2>
                <p>Anoveyは完全匿名性。顔出し無しの音声通話を用いているため、<br>身元を特定されることなく転職相談が可能です。
                </p>
            </div>
        ...
        <div class="flex justify-center">
            ...
            <div class="ml-20 text-gray-700">
                <h2 class="text-teal-500 text-2xl font-bold mb-6 mt-12">10分の相談だから、スピーディー</h2>
                <p>たったの10分間だから、面倒な日程調整も簡単。その後、内定先のメンターとチャットでやり取りも可能です。<br>転職先に少しでも不安がある方は是非ご利用ください。</p>
            </div>
        </div>
    </div>
